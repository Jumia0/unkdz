...
class KDZFileTools(kdz.KDZFile):
    ...
    def run(self, kdzfile, outdir, listOnly=0, extractID=0, extractAll=1):
        self.kdzfile = kdzfile
        self.openFile(self.kdzfile)
        self.partList = self.getPartitions()
        ...
        if listOnly:
            ...
            if extractID >= 0 and extractID < len(self.partList):
                ...
                print("[!] Segment {:d} is out of range!".format(extractID), file=sys.stderr)
